...
const InteractionsOverview = ({ className = '' }: InteractionsOverviewProps) => {
  const interactions = [
    {
      icon: <Video className="h-10 w-10 text-gray-700" />,
    ...
    {
      icon: <Play className="h-10 w-10 text-gray-700" />,
    ...
    {
      icon: <Monitor className="h-10 w-10 text-gray-700" />,
      title: "Picture-in-Picture (PiP)",
    },
    {
      icon: <BarChart2 className="h-10 w-10 text-gray-700" />,
    ...
    {
      icon: <PenTool className="h-10 w-10 text-gray-700" />,
      title: "Multilingual AI Voice Personalization",
    },
    {
      icon: <Share2 className="h-10 w-10 text-gray-700" />,
  ...
  return (
    <section className={`py-20 bg-gray-100 ${className}`}>
      <div className="container-custom">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          <h2 className="text-4xl font-bold mb-4 text-gray-700">Interactive Video Capabilities</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {interactions.map((item, index) => (
            <div 
              key={index} 
              className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col items-center text-center border border-gray-300"
            >
